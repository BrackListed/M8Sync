...
var _chunkEARDDQSBcjs = require('./chunk-EARDDQSB.cjs');
...
function normalizedURLFromServers(servers, selected) {
  ...
  const resolvedUrl = _optionalChain([server, 'optionalAccess', _8 => _8.url, 'optionalAccess', _9 => _9.replace, 'call', _10 => _10(_chunkY5HU4SVHcjs.SERVER_VARIABLE_REGEX, (original, key) => {
...
function objectify(thing) {
  if (!_chunkY5HU4SVHcjs.isObject.call(void 0, thing)) {
    return {};
  }
  return thing;
}
...
function sampleFromSchema(schema, opts = {}) {
  ...
  if (opts.definition && _chunk7PWF3F2Wcjs.isRef.call(void 0, objectifySchema)) {
    ...
    objectifySchema = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, objectifySchema, opts.definition, seenRefs);
...
function sampleFromResolvedSchema(schema, opts, seenRefs) {
  ...
  if (example !== void 0) {
    return _chunkY5HU4SVHcjs.dereferenceRefDeep.call(void 0, example, opts.definition, seenRefs);
  }
    ...
    try {
      ...
      const resolvedAllOf = schema.allOf.map((subSchema) => {
        ...
        if (definition && _chunk7PWF3F2Wcjs.isRef.call(void 0, sub)) {
          const resolved = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, sub, definition, /* @__PURE__ */ new Set());
...
function getMediaTypeExamples(mediaType, mediaTypeObject, definition, opts = {}) {
  if (mediaTypeObject.example) {
    mediaTypeObject.example = _chunkY5HU4SVHcjs.dereferenceRefDeep.call(void 0, mediaTypeObject.example, definition);
    if (mediaTypeObject.example === void 0 || _chunkY5HU4SVHcjs.collectRefsInSchema.call(void 0, mediaTypeObject.example).size > 0) {
      return [];
    }
    return [
      {
    ...
    const multipleExamples = Object.keys(examples).map((key) => {
      ...
      if (example !== null && typeof example === "object") {
        if (_chunk7PWF3F2Wcjs.isRef.call(void 0, example)) {
          example = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, example, definition);
        ...
        if ("value" in example) {
          example.value = _chunkY5HU4SVHcjs.dereferenceRefDeep.call(void 0, example.value, definition);
          if (example.value === void 0 || _chunkY5HU4SVHcjs.collectRefsInSchema.call(void 0, example.value).size > 0) {
            return false;
          }
  ...
  if (mediaTypeObject.schema) {
    if (!_chunkY5HU4SVHcjs.matches_mimetype_default.xml(mediaType)) {
      return [
        {
...
function getResponseExamples(operation, definition) {
  return Object.keys(operation.responses || {}).map((status) => {
    ...
    if (_chunk7PWF3F2Wcjs.isRef.call(void 0, response)) {
      response = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, response, definition);
...
function getCallbackExamples(operation, definition) {
  ...
  const examples = Object.keys(operation.callbacks).map((identifier) => {
    ...
    if (_chunk7PWF3F2Wcjs.isRef.call(void 0, callback)) {
      callback = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, callback, definition);
    ...
    const items = Object.keys(callback).map((expression) => {
      ...
      if (_chunk7PWF3F2Wcjs.isRef.call(void 0, callbackPath)) {
        callbackPath = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, callbackPath, definition);
...
function getExampleGroups(operation) {
  ...
  const groups = {};
  const codeSamples = _chunkEARDDQSBcjs.getExtension.call(void 0, "code-samples", operation.api, operation);
  ...
  operation.getParameters().forEach((param) => {
    Object.entries(param.examples || {}).forEach(([exampleKey, paramExample]) => {
      ...
      if (_chunk7PWF3F2Wcjs.isRef.call(void 0, example)) {
        example = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, example, operation.api);
...
function getRequestBodyExamples(operation, definition) {
  ...
  if (!requestBody) {
    ...
    requestBody = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, requestBody, definition);
  }
...
var isJSON = _chunkY5HU4SVHcjs.matches_mimetype_default.json;
  ...
  if (response.headers) {
    Object.keys(response.headers).forEach((key) => {
      ...
      if (_chunk7PWF3F2Wcjs.isRef.call(void 0, headerEntry)) {
        headerEntry = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, headerEntry, api, seenRefs);
      ...
      if (headerEntry.schema) {
        ...
        if (_chunk7PWF3F2Wcjs.isRef.call(void 0, headerSchema)) {
          headerSchema = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, headerSchema, api, seenRefs);
          if (!headerSchema || _chunk7PWF3F2Wcjs.isRef.call(void 0, headerSchema)) return;
        }
        headersSchema.properties[key] = _chunkY5HU4SVHcjs.toJSONSchema.call(void 0, _chunkY5HU4SVHcjs.cloneObject.call(void 0, headerSchema), {
...
function getResponseAsJSONSchema(operation, api, statusCode, opts) {
  ...
  function getPreferredSchema(content, preferredContentType) {
    ...
    if (preferredContentType) {
      if (contentTypes.includes(preferredContentType)) {
        const schema2 = _chunkY5HU4SVHcjs.cloneObject.call(void 0, content[preferredContentType].schema);
        if (!schema2) {
          return null;
        }
        return _chunkY5HU4SVHcjs.toJSONSchema.call(void 0, schema2, baseSchemaOptions);
      }
      return null;
    }
    for (let i = 0; i < contentTypes.length; i++) {
      if (isJSON(contentTypes[i])) {
        const schema2 = _chunkY5HU4SVHcjs.cloneObject.call(void 0, content[contentTypes[i]].schema);
        if (!schema2) {
          return {};
        }
        return _chunkY5HU4SVHcjs.toJSONSchema.call(void 0, schema2, baseSchemaOptions);
    ...
    const schema = _chunkY5HU4SVHcjs.cloneObject.call(void 0, content[contentType].schema);
    if (!schema) {
      return {};
    }
    return _chunkY5HU4SVHcjs.toJSONSchema.call(void 0, schema, baseSchemaOptions);
  }
  ...
  if (foundSchema) {
    ...
    const schemaWrapper = {
      ...
      schema: _chunkY5HU4SVHcjs.isPrimitive.call(void 0, schema) ? schema : {
        ...schema,
        $schema: _chunkY5HU4SVHcjs.getSchemaVersionString.call(void 0, schema, api)
      },
      label: "Response body"
    };
    ...
    _chunkY5HU4SVHcjs.applyDiscriminatorOneOfToUsedSchemas.call(void 0, api, usedSchemas, (ref) => {
      if (usedSchemas.has(ref)) {
        return usedSchemas.get(ref);
      }
      try {
        const resolved = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, { $ref: ref }, api, seenRefs);
        if (_chunk7PWF3F2Wcjs.isRef.call(void 0, resolved)) return;
        const converted = _chunkY5HU4SVHcjs.toJSONSchema.call(void 0, structuredClone(resolved), {
          ...baseSchemaOptions,
          seenRefs
        });
    ...
    if (schemaWrapper.schema && usedSchemas.size > 0) {
      const refsInOutput = _chunkY5HU4SVHcjs.collectRefsInSchema.call(void 0, schemaWrapper.schema);
      const refsInGroup = _nullishCoalesce(refsByGroup.get("body"), () => ( /* @__PURE__ */ new Set()));
      const referencedSchemas = _chunkY5HU4SVHcjs.filterRequiredRefsToReferenced.call(void 0, /* @__PURE__ */ new Set([...refsInGroup, ...refsInOutput]), usedSchemas);
      if (referencedSchemas.size > 0) {
        _chunkY5HU4SVHcjs.mergeReferencedSchemasIntoRoot.call(void 0, schemaWrapper.schema, referencedSchemas);
      }
    }
  ...
  if (response.headers) {
    ...
    if (headersWrapper.schema && usedSchemas.size > 0) {
      ...
      const refsInOutput = _chunkY5HU4SVHcjs.collectRefsInSchema.call(void 0, headersWrapper.schema);
      const referencedSchemas = _chunkY5HU4SVHcjs.filterRequiredRefsToReferenced.call(void 0, /* @__PURE__ */ new Set([...refsInGroup, ...refsInOutput]), usedSchemas);
      if (referencedSchemas.size > 0) {
        _chunkY5HU4SVHcjs.mergeReferencedSchemasIntoRoot.call(void 0, headersWrapper.schema, referencedSchemas);
      }
    }
...
var Operation = class {
  ...
  getServers() {
    ...
    if (_optionalChain([this, 'access', _81 => _81.api, 'access', _82 => _82.paths, 'optionalAccess', _83 => _83[this.path]])) {
      const pathItem = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, this.api.paths[this.path], this.api);
  ...
  getContentType() {
    ...
    if (this.schema.requestBody) {
      if (_chunk7PWF3F2Wcjs.isRef.call(void 0, this.schema.requestBody)) {
        this.schema.requestBody = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, this.schema.requestBody, this.api);
      }
    ...
    types.forEach((t) => {
      if (_chunkY5HU4SVHcjs.matches_mimetype_default.json(t)) {
        this.contentType = t;
      }
    });
    return this.contentType;
   ...
   */
  isFormUrlEncoded() {
    return _chunkY5HU4SVHcjs.matches_mimetype_default.formUrlEncoded(this.getContentType());
  }
  /**
   ...
   */
  isMultipart() {
    return _chunkY5HU4SVHcjs.matches_mimetype_default.multipart(this.getContentType());
  }
  /**
   ...
   */
  isJson() {
    return _chunkY5HU4SVHcjs.matches_mimetype_default.json(this.getContentType());
  }
  /**
   ...
   */
  isXml() {
    return _chunkY5HU4SVHcjs.matches_mimetype_default.xml(this.getContentType());
  }
  /**
      ...
      const keysWithTypes = keys.map((key) => {
        ...
        try {
          ...
          if (_chunk7PWF3F2Wcjs.isRef.call(void 0, security)) {
            security = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, security, this.api);
  ...
  getHeaders() {
      ...
      this.headers.request = this.headers.request.concat(
        this.schema.parameters.map((p) => {
          ...
          if (_chunk7PWF3F2Wcjs.isRef.call(void 0, param)) {
            param = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, param, this.api);
    ...
    if (this.schema.responses) {
      this.headers.response = Object.keys(this.schema.responses).map((r) => {
        ...
        if (!response) return [];
        if (_chunk7PWF3F2Wcjs.isRef.call(void 0, response)) {
          this.schema.responses[r] = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, response, this.api);
    ...
    if (!this.headers.request.includes("Content-Type") && this.schema.requestBody) {
      ...
      if (requestBody) {
        if (_chunk7PWF3F2Wcjs.isRef.call(void 0, requestBody)) {
          this.schema.requestBody = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, requestBody, this.api);
  ...
  getParameters() {
    ...
    const commonParams = (_optionalChain([this, 'access', _108 => _108.getCommonParameterContainer, 'call', _109 => _109(), 'optionalAccess', _110 => _110.parameters]) || []).map((p) => {
      let param = p;
      if (_chunk7PWF3F2Wcjs.isRef.call(void 0, param)) {
        param = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, param, this.api);
        if (!param || _chunk7PWF3F2Wcjs.isRef.call(void 0, param)) return;
   ...
   */
  getCommonParameterContainer() {
    const pathItem = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, _optionalChain([this, 'access', _111 => _111.api, 'optionalAccess', _112 => _112.paths, 'optionalAccess', _113 => _113[this.path]]), this.api);
  ...
  getParametersAsJSONSchema(opts = {}) {
    _chunkY5HU4SVHcjs.decorateComponentSchemasWithRefName.call(void 0, this.api);
    return _chunkY5HU4SVHcjs.getParametersAsJSONSchema.call(void 0, this, this.api, {
  ...
  getResponseStatusCodes() {
    ...
    if (_chunk7PWF3F2Wcjs.isRef.call(void 0, this.schema.responses)) {
      this.schema.responses = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, this.schema.responses, this.api);
    ...
    return Object.keys(this.schema.responses).filter((key) => {
      ...
      const response = _optionalChain([this, 'access', _114 => _114.schema, 'access', _115 => _115.responses, 'optionalAccess', _116 => _116[key]]);
  ...
  getResponseContentTypes() {
    ...
    Object.values(this.schema.responses).forEach((response) => {
      ...
      if (_chunk7PWF3F2Wcjs.isRef.call(void 0, resp)) {
        resp = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, resp, this.api);
  ...
  getRequestBody(mediaType) {
    ...
    mediaTypes.forEach((mt) => {
      if (!availableMediaType && _chunkY5HU4SVHcjs.matches_mimetype_default.json(mt)) {
  ...
  getRequestBodyExamples() {
    const isRequestExampleValueDefined = typeof _optionalChain([this, 'access', _117 => _117.requestBodyExamples, 'optionalAccess', _118 => _118[0], 'optionalAccess', _119 => _119.examples, 'optionalAccess', _120 => _120[0], 'access', _121 => _121.value]) !== "undefined";
  ...
  getResponseByStatusCode(statusCode) {
    ...
    if (!response) return false;
    if (_chunk7PWF3F2Wcjs.isRef.call(void 0, response)) {
      this.schema.responses[statusCode] = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, response, this.api);
  ...
  getCallback(identifier, expression, method) {
    ...
    if (_chunk7PWF3F2Wcjs.isRef.call(void 0, callbackObj)) {
      this.schema.callbacks[identifier] = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, callbackObj, this.api);
    ...
    if (_chunk7PWF3F2Wcjs.isRef.call(void 0, callback)) {
      callbackObj[expression] = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, callback, this.api);
  ...
  getCallbacks() {
    ...
    Object.keys(this.schema.callbacks).forEach((callback) => {
      let cb = _optionalChain([this, 'access', _122 => _122.schema, 'access', _123 => _123.callbacks, 'optionalAccess', _124 => _124[callback]]);
      if (!cb) return;
      if (_chunk7PWF3F2Wcjs.isRef.call(void 0, cb)) {
        this.schema.callbacks[callback] = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, cb, this.api);
      ...
      Object.keys(cb).forEach((expression) => {
        ...
        if (!callbackPath) return;
        if (_chunk7PWF3F2Wcjs.isRef.call(void 0, callbackPath)) {
          cb[expression] = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, callbackPath, this.api);
        ...
        Object.keys(callbackPath).forEach((method) => {
          if (!_chunkY5HU4SVHcjs.supportedMethods.includes(method)) return;
  ...
  getExtension(extension) {
    return _optionalChain([this, 'access', _125 => _125.schema, 'optionalAccess', _126 => _126[extension]]);
  }
  /**
...
var Callback = class extends Operation {
   ...
   */
  getSummary() {
    if (_optionalChain([this, 'access', _127 => _127.schema, 'optionalAccess', _128 => _128.summary]) && typeof this.schema.summary === "string") {
      return this.schema.summary;
   ...
   */
  getDescription() {
    if (_optionalChain([this, 'access', _129 => _129.schema, 'optionalAccess', _130 => _130.description]) && typeof this.schema.description === "string") {
      return this.schema.description;
   ...
   */
  getParameters() {
    let parameters = (_optionalChain([this, 'access', _131 => _131.schema, 'optionalAccess', _132 => _132.parameters]) || []).map((p) => {
      let param = p;
      if (_chunk7PWF3F2Wcjs.isRef.call(void 0, param)) {
        param = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, param, this.api);
        if (!param || _chunk7PWF3F2Wcjs.isRef.call(void 0, param)) return;
...
var Webhook = class extends Operation {
   ...
   */
  getCommonParameterContainer() {
    const pathItem = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, _optionalChain([this, 'access', _133 => _133.api, 'optionalAccess', _134 => _134.webhooks, 'optionalAccess', _135 => _135[this.path]]), this.api);
    if (!pathItem || _chunk7PWF3F2Wcjs.isRef.call(void 0, pathItem)) {
      return void 0;
    }
    return pathItem;
   ...
   */
  getSummary() {
    if (_optionalChain([this, 'access', _136 => _136.schema, 'optionalAccess', _137 => _137.summary]) && typeof this.schema.summary === "string") {
      return this.schema.summary;
    ...
    if (_chunk7PWF3F2Wcjs.isRef.call(void 0, webhookPath)) {
      this.api.webhooks[this.path] = _chunkY5HU4SVHcjs.dereferenceRef.call(void 0, webhookPath, this.api);
      webhookPath = this.api.webhooks[this.path];
    }
    return _optionalChain([webhookPath, 'optionalAccess', _138 => _138.summary]);
  }
  /**
   * Retrieve the `description` for this operation.
   *
   ...
   */
  getDescription() {
    if (_optionalChain([this, 'access', _139 => _139.schema, 'optionalAccess', _140 => _140.description]) && typeof this.schema.description === "string") {
      return this.schema.description;
    } else if (!this.api.webhooks) {
      return void 0;
    }
    ...
    return _optionalChain([webhookPath, 'optionalAccess', _141 => _141.description]);
  }
};
...
exports.getUserVariable = getUserVariable; exports.stripTrailingSlash = stripTrailingSlash; exports.escapeRegExp = escapeRegExp; exports.normalizeURL = normalizeURL; exports.variablesFromServers = variablesFromServers; exports.defaultVariablesFromServers = defaultVariablesFromServers; exports.splitUrlFromServers = splitUrlFromServers; exports.transformURLIntoRegex = transformURLIntoRegex; exports.generatePathMatches = generatePathMatches; exports.filterPathMethods = filterPathMethods; exports.findTargetPath = findTargetPath; exports.Operation = Operation; exports.Callback = Callback; exports.Webhook = Webhook;
/**
 ...
 */
//# sourceMappingURL=chunk-7DE5LTVI.cjs.map