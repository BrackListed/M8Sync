import { PathsObject, HttpMethods, OASDocument, User, ServerVariable, ServerVariablesObject, Servers, AuthForHAR, SecuritySchemeObject, DataForHAR, SchemaObject, OAS31Document, PathItemObject, OperationObject, ServerObject, SecurityRequirementObject, KeyedSecuritySchemeObject, SecurityType, TagObject, ParameterObject, SchemaWrapper, MediaTypeObject, ResponseObject } from './types.js';
import { Match, ParamData } from 'path-to-regexp';
import { g as getParametersAsJSONSchemaOptions } from './get-parameters-as-json-schema-BZjPPE3y.js';
import 'json-schema';
...
declare class Oas {
     ...
     */
    private pathItemForRootServerMatching;
    /**
 ...
 * }
 */
declare const APPLY_TAG_CHANGES = "apply-tag-changes";
/**
...
export { APPLY_TAG_CHANGES as A, Callback as C, DISABLE_TAG_SORTING as D, EXPLORER_ENABLED as E, HEADERS as H, INTERNAL as I, METRICS_ENABLED as M, Operation as O, PARAMETER_ORDERING as P, SAMPLES_LANGUAGES as S, Webhook as W, CODE_SAMPLES as a, type Extensions as b, OAUTH_OPTIONS as c, PROXY_ENABLED as d, Oas as default, SIMPLE_MODE as e, STATUS_URL as f, extensionDefaults as g, getExtension as h, hasRootExtension as i, validateParameterOrdering as v };
