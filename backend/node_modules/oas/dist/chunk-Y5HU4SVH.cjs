  ...
  function convertExamples(obj) {
    if ("example" in obj) {
      ...
      if (typeof obj.examples === "object" && obj.examples !== null && !Array.isArray(obj.examples)) {
        ...
        reshapedExamples = true;
      } else if (Array.isArray(obj.examples) && isObject(obj.examples[0])) {
        prevExampleSchemas.push({ example: obj.examples[0] });
      }
      if (!reshapedExamples) {
        delete obj.examples;
      }
...
function getParametersAsJSONSchema(operation, api, opts) {
  ...
  const typeKeys = _chunkEARDDQSBcjs.getExtension.call(void 0, _chunkEARDDQSBcjs.PARAMETER_ORDERING, api, operation).map((k) => k.toLowerCase());
...
//# sourceMappingURL=chunk-Y5HU4SVH.cjs.map